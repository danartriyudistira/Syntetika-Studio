...
- Added environment variable for setting syntetika data dir
- Added support for template projects (.bskt)
- Added 14-bit midi CC support, and added integration for custom "syntetika turn" controller
...
- Simplify syntetika turn string communication, and fix issue where value string wasn't updating frequently enough
...
- Fixed an issue where holding space when syntetika isn't focused would cause mouse movements to pan the canvas
...
- Added the ability to execute "console" commands directly from OSC using the `/syntetika/console` address
...
- Change default zoom level and ui scale of syntetika to 1.3
...
- VST manager window with scanning as a sub process (prevents crashing Syntetika while scanning)
...
- Fixed syntetika starting up with a window size larger than the display
...
- Display syntetika version on error screen
...
[unreleased]: https://github.com/Syntetika/Syntetika/compare/v1.2.1...main
[1.2.1]: https://github.com/Syntetika/Syntetika/compare/v1.2.0...v1.2.1
[1.2.0]: https://github.com/Syntetika/Syntetika/compare/v1.1.0...v1.2.0
[1.1.0]: https://github.com/Syntetika/Syntetika/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/Syntetika/Syntetika/tree/v1.0.0
