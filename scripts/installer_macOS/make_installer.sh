...
OUTPUT_BASE_FILENAME="Syntetika-Mac-$VERSION"

mkdir -p "${TARGET_DIR}"
echo "{ \"title\": \"Syntetika\", \"background\": \"${SOURCEDIR}/background.png\", \"icon-size\": 80," > dmg_manifest.json
echo "\"contents\": [ { \"x\": 192, \"y\": 338, \"type\": \"file\", \"path\": \"${INDIR}/Syntetika.app\"}, " >> dmg_manifest.json 
