...
<html lang="en">
   ...
   <head>
      <title>syntetika Synth Reference</title>
...
html = open("Syntetika.com/docs/index.html", "w")
html.write(before)
html.write('''
         <nav class="menu">
            
            <ul></br>syntetika Synth Reference</br></br>
...
html.write('''
      <main class="main">
         <a name=video></a></br>
         <h1>syntetika Synth Reference</h1>
         <h2>overview video</h2>
         <span style="display:inline-block;margin-left:15px;">
         <p>Here is a video detailing basic usage of syntetika, including a bunch of less-obvious shortcuts and workflow features.</p>
