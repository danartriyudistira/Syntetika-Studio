...
for line in lines:
   ...
   if m:
      ...
      isBootstrapModule = currentModule == "syntetika" or currentModule == "scriptmodule"
      if currentModule == "scriptmodule":
         currentModule = "me"
      docLine("\n")
      if isBootstrapModule:
         tab = "   "
         if currentModule == "syntetika":
            docLine("globals:")
         if currentModule == "me":
