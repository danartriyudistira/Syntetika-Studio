...
//==============================================================================
class SyntetikaApplication : public JUCEApplication
{
public:
   //==============================================================================
   SyntetikaApplication() = default;

   const String getApplicationName() override { return Syntetika::APP_NAME; }
   const String getApplicationVersion() override { return Syntetika::VERSION; }
   ...
   void initialise(const String& commandLine) override
   {
      ...
      for (int i = 0; i < cliArgv.size(); ++i)
      {
         ...
         {
            std::cout << "syntetika synth " << GetBuildInfoString() << std::endl;
            should_exit = true;
         }
      ...
      mainWindow = std::make_unique<MainWindow>("syntetika synth");

      juce::PropertiesFile::Options options;
      options.applicationName = "Syntetika";
...
START_JUCE_APPLICATION(SyntetikaApplication)
