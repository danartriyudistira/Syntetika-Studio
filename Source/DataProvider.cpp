...
void DataProvider::CreateUIControls()
{
   ...
   mTypeSelectorDropdown->AddSeparator(mTypeSelectorDropdown->GetNumValues());
   mTypeSelectorDropdown->AddLabel("Syntetika: All modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Note modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Synth modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Audio modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Instrument modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Processor modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Modulator modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Pulse modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Other modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Unknown modules", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Cable sources", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Cables", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Is savestate loaded", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Version major", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Version minor", interval++);
   mTypeSelectorDropdown->AddLabel("Syntetika: Version patch", interval++);
...
void DataProvider::Go(double time)
{
   ...
   switch (mTypeSelectorIndex)
   {
      ...
      case 53:
         ...
         break;
      case 54:
         mValue = ofToDouble(ofSplitString(Syntetika::VERSION, ".")[0]);
         break;
      case 55:
         mValue = ofToDouble(ofSplitString(Syntetika::VERSION, ".")[1]);
         break;
      case 56:
         mValue = ofToDouble(ofSplitString(Syntetika::VERSION, ".")[2]);
         break;
   }
