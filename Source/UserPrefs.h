...
public:
   ...
   UserPrefFloat cable_quality{ "cable_quality", 1, .1f, 3, UserPrefCategory::Graphics };
    UserPrefFloat lissajous_r{ "lissajous_r", 0.020f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat lissajous_g{ "lissajous_g", 0.031f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat lissajous_b{ "lissajous_b", 0.024f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat background_r{ "background_r", 0.020f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat background_g{ "background_g", 0.020f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat background_b{ "background_b", 0.020f, 0, 1, UserPrefCategory::Graphics };
   ...
   UserPrefFloat grid_alpha{ "grid_alpha", 20, 0, 100, UserPrefCategory::Graphics };
   UserPrefFloat module_saturation{ "module_saturation", 224, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat module_brightness{ "module_brightness", 175, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat note_hue{ "note_hue", 101, 0, 360, UserPrefCategory::Graphics };
   UserPrefFloat audio_hue{ "audio_hue", 96, 0, 360, UserPrefCategory::Graphics };
   UserPrefFloat synth_hue{ "synth_hue", 101, 0, 360, UserPrefCategory::Graphics };
   UserPrefFloat instrument_hue{ "instrument_hue", 106, 0, 360, UserPrefCategory::Graphics };
   UserPrefFloat processor_hue{ "processor_hue", 130, 0, 360, UserPrefCategory::Graphics };
   UserPrefFloat processor_sat{ "processor_sat", 200, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat processor_bri{ "processor_bri", 165, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat modulator_hue{ "modulator_hue", 165, 0, 360, UserPrefCategory::Graphics };
   UserPrefFloat modulator_sat{ "modulator_sat", 180, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat modulator_bri{ "modulator_bri", 155, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat pulse_hue{ "pulse_hue", 50, 0, 360, UserPrefCategory::Graphics };
   UserPrefFloat pulse_sat{ "pulse_sat", 224, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat pulse_bri{ "pulse_bri", 175, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat visual_hue{ "visual_hue", 240, 0, 360, UserPrefCategory::Graphics };
   UserPrefFloat visual_sat{ "visual_sat", 150, 0, 255, UserPrefCategory::Graphics };
   UserPrefFloat visual_bri{ "visual_bri", 155, 0, 255, UserPrefCategory::Graphics };
