...
public:
   ...
   UserPrefFloat cable_quality{ "cable_quality", 1, .1f, 3, UserPrefCategory::Graphics };
    UserPrefFloat lissajous_r{ "lissajous_r", 0.078f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat lissajous_g{ "lissajous_g", 0.157f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat lissajous_b{ "lissajous_b", 0.235f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat background_r{ "background_r", 0.031f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat background_g{ "background_g", 0.031f, 0, 1, UserPrefCategory::Graphics };
    UserPrefFloat background_b{ "background_b", 0.078f, 0, 1, UserPrefCategory::Graphics };
