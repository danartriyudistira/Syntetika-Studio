...
void HelpDisplay::CreateUIControls()
{
   ...
   mDocsLinkButton = new ClickButton(this, "syntetika.com/docs", 95, 80);
   mDiscordLinkButton = new ClickButton(this, "syntetika discord", 304, 80);
...
void HelpDisplay::ButtonClicked(ClickButton* button, double time)
{
   ...
   {
      juce::URL("http://syntetika.com/docs").launchInDefaultBrowser();
   }
   ...
   {
      juce::SystemClipboard::copyTextToClipboard("syntetika " + juce::String(GetBuildInfoString()) + " - " + juce::SystemStats::getOperatingSystemName() + " - " + Syntetika::GIT_BRANCH + " " + Syntetika::GIT_HASH);
   }
         ...
         for (auto toSpawn : modules)
         {
            ...
            switch (module->GetModuleCategory())
            {
               ...
               case kModuleCategory_Modulator: moduleType = "modulators"; break;
                ...
                case kModuleCategory_Visual: moduleType = "visual"; break;
