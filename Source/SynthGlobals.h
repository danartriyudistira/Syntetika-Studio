...
//#define SYNTETIKA_DEBUG_ALLOCATIONS

#ifdef SYNTETIKA_DEBUG_ALLOCATIONS
...
#define SYNTETIKA_SUPPRESS_NIGHTLY_LABEL 1
...
extern Syntetika::core::Xoshiro256ss gRandom;
...
public:
   ...
   ofLog& operator!()
   {
      mSendToSyntetikaConsole = false;
      return *this;
   }

private:
   std::string mMessage;
   bool mSendToSyntetikaConsole;
};
