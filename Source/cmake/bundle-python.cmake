...
set(SYNTETIKA_PIP_PACKAGES jedi)
...
if(APPLE)
    ...
    execute_process(COMMAND "${pyExecutable}" -m pip install ${SYNTETIKA_PIP_PACKAGES} COMMAND_ECHO STDOUT)
elseif(WIN32)
    ...
    execute_process(COMMAND "${pyExecutable}" -m pip install ${SYNTETIKA_PIP_PACKAGES})
else()
    get_filename_component(pySO "${Python_LIBRARIES}" REALPATH)
