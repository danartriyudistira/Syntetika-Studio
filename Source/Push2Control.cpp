...
void Push2Control::CreateUIControls()
{
   ...
   mSpawnModuleControls.push_back(mSpawnLists.mVisualModules.GetList());
...
ModuleCategory Push2Control::GetModuleTypeForSpawnList(IUIControl* control)
{
   ...
   if (control == mSpawnLists.mVisualModules.GetList())
      moduleType = kModuleCategory_Visual;
