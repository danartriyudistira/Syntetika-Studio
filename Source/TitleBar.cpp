...
, mVisualModules(owner, 0, 0, "visual:", kModuleCategory_Visual, true)
...
void SpawnListManager::SetModuleFactory(ModuleFactory* factory)
{
   ...
   mVisualModules.SetList(factory->GetSpawnableModules(kModuleCategory_Visual));
   ...
   mDropdowns.push_back(&mVisualModules);
